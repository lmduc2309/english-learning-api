# AI Generation Declaration — DSD-AI-PILOT-050-B001

- Declaration ID: `DSD-AI-DECL-20260809-001`
- Batch: `DSD-AI-PILOT-050-B001`
- Origin actor: `DSD-G-001`
- Tool: `openai-codex-text-generation`
- Provider/product: `openai` / `codex`
- Runtime model ID: `codex-runtime-undisclosed` (the exact serving model was not exposed; no model name is guessed)
- Source: `openai-dsd-generated-v1`
- Generated at: `2026-08-09T06:07:37Z`
- Inventory input SHA-256: `02a9fbfca3112a7178ea8e379266ec910e46c2110cf0cd5179dd07c94572552e`
...
contain a legacy definition, translation, example, pronunciation, legacy row
identifier, blocked dictionary extract, similarity match or source wording.
